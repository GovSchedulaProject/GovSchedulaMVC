...
namespace GovSchedulaWeb.Models.Data.Services
{
    public class VoterRegService
    {
        ...
        public VoterRegService(GovSchedulaDbContext context)
        {
            _context = context;
        }

        public async Task AddVoterAsync(
            VoterRegistrationViewModel model,
            int userId)
        {
            ...
            try
            {
                ...
                model.GeneralDetail.DepartmentId = 2;
                ...
                model.VoterIdRegistration.GeneralDetailsId = model.GeneralDetail.GeneralDetailsId;
                model.VoterIdRegistration.StatusId = 1;
                _context.VoterIdregistrations.Add(model.VoterIdRegistration);
                await _context.SaveChangesAsync();
                Console.WriteLine($"Passport registration saved with ID: {model.VoterIdRegistration.VoterId}");
